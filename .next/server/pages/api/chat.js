"use strict";(()=>{var e={};e.id=170,e.ids=[170],e.modules={145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},1731:(e,t,i)=>{i.r(t),i.d(t,{config:()=>l,default:()=>s,routeModule:()=>c});var o={};i.r(o),i.d(o,{default:()=>handler});var n=i(1802),a=i(7153),r=i(6249);async function handler(e,t){if("POST"!==e.method)return t.status(405).end();let{messages:i}=e.body,o=`You are Mehwish Riaz's personal AI assistant on her portfolio website. Be helpful, friendly, and concise.
...
Answer questions about Mehwish's skills, experience, projects, certifications, and how to contact her. Keep responses concise and professional.`;try{let e=await fetch("https://api.groq.com/openai/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${process.env.GROQ_API_KEY}`},body:JSON.stringify({model:"llama-3.3-70b-versatile",messages:[{role:"system",content:o},...i],max_tokens:512,temperature:.7})}),n=await e.json();t.json({reply:n.choices?.[0]?.message?.content||"I couldn't generate a response. Please try again."})}catch(e){t.status(500).json({reply:"Sorry, I'm having trouble right now. Please reach out via the contact page!"})}}let s=(0,r.l)(o,"default"),l=(0,r.l)(o,"config"),c=new n.PagesAPIRouteModule({definition:{kind:a.x.PAGES_API,page:"/api/chat",pathname:"/api/chat",bundlePath:"",filename:""},userland:o})}};var t=require("../../webpack-api-runtime.js");t.C(e);var __webpack_exec__=e=>t(t.s=e),i=t.X(0,[222],()=>__webpack_exec__(1731));module.exports=i})();